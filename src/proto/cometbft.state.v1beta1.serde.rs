...
impl serde::Serialize for AbciResponses {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.state.v1beta1.ABCIResponses", len)?;
        if !self.deliver_txs.is_empty() {
...
impl<'de> serde::Deserialize<'de> for AbciResponses {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.state.v1beta1.ABCIResponses")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<AbciResponses, V::Error>
                where
        ...
        deserializer.deserialize_struct("cometbft.state.v1beta1.ABCIResponses", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for AbciResponsesInfo {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.state.v1beta1.ABCIResponsesInfo", len)?;
...
impl<'de> serde::Deserialize<'de> for AbciResponsesInfo {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.state.v1beta1.ABCIResponsesInfo")
            }
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::AbciResponses => {
                            ...
                            abci_responses__ = map_.next_value()?;
                        }
        ...
        deserializer.deserialize_struct("cometbft.state.v1beta1.ABCIResponsesInfo", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ConsensusParamsInfo {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.state.v1beta1.ConsensusParamsInfo", len)?;
...
impl<'de> serde::Deserialize<'de> for ConsensusParamsInfo {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.state.v1beta1.ConsensusParamsInfo")
            }
        ...
        deserializer.deserialize_struct("cometbft.state.v1beta1.ConsensusParamsInfo", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for State {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.state.v1beta1.State", len)?;
...
impl<'de> serde::Deserialize<'de> for State {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.state.v1beta1.State")
            }
        ...
        deserializer.deserialize_struct("cometbft.state.v1beta1.State", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ValidatorsInfo {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.state.v1beta1.ValidatorsInfo", len)?;
...
impl<'de> serde::Deserialize<'de> for ValidatorsInfo {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.state.v1beta1.ValidatorsInfo")
            }
        ...
        deserializer.deserialize_struct("cometbft.state.v1beta1.ValidatorsInfo", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Version {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.state.v1beta1.Version", len)?;
...
impl<'de> serde::Deserialize<'de> for Version {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.state.v1beta1.Version")
            }
        ...
        deserializer.deserialize_struct("cometbft.state.v1beta1.Version", FIELDS, GeneratedVisitor)
    }
}
