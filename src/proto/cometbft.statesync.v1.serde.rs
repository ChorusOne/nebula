...
impl serde::Serialize for ChunkRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.statesync.v1.ChunkRequest", len)?;
        if self.height != 0 {
...
impl<'de> serde::Deserialize<'de> for ChunkRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.statesync.v1.ChunkRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<ChunkRequest, V::Error>
                where
        ...
        deserializer.deserialize_struct("cometbft.statesync.v1.ChunkRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ChunkResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.statesync.v1.ChunkResponse", len)?;
        if self.height != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("height", ToString::to_string(&self.height).as_str())?;
...
impl<'de> serde::Deserialize<'de> for ChunkResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.statesync.v1.ChunkResponse")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<ChunkResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut height__ = None;
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        ...
                        GeneratedField::Missing => {
                            ...
                            missing__ = Some(map_.next_value()?);
                        }
                    }
                }
                Ok(ChunkResponse {
        ...
        deserializer.deserialize_struct("cometbft.statesync.v1.ChunkResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Message {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.statesync.v1.Message", len)?;
...
impl<'de> serde::Deserialize<'de> for Message {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.statesync.v1.Message")
            }
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::SnapshotsRequest => {
                            ...
                            sum__ = map_.next_value::<::std::option::Option<_>>()?.map(message::Sum::SnapshotsRequest)
;
                        }
                        GeneratedField::SnapshotsResponse => {
                            ...
                            sum__ = map_.next_value::<::std::option::Option<_>>()?.map(message::Sum::SnapshotsResponse)
;
                        }
                        GeneratedField::ChunkRequest => {
                            ...
                            sum__ = map_.next_value::<::std::option::Option<_>>()?.map(message::Sum::ChunkRequest)
;
                        }
                        GeneratedField::ChunkResponse => {
                            ...
                            sum__ = map_.next_value::<::std::option::Option<_>>()?.map(message::Sum::ChunkResponse)
;
                        }
                    }
                }
        ...
        deserializer.deserialize_struct("cometbft.statesync.v1.Message", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for SnapshotsRequest {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("cometbft.statesync.v1.SnapshotsRequest", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for SnapshotsRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.statesync.v1.SnapshotsRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<SnapshotsRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
        ...
        deserializer.deserialize_struct("cometbft.statesync.v1.SnapshotsRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for SnapshotsResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.statesync.v1.SnapshotsResponse", len)?;
        if self.height != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("height", ToString::to_string(&self.height).as_str())?;
...
impl<'de> serde::Deserialize<'de> for SnapshotsResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.statesync.v1.SnapshotsResponse")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<SnapshotsResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut height__ = None;
        ...
        deserializer.deserialize_struct("cometbft.statesync.v1.SnapshotsResponse", FIELDS, GeneratedVisitor)
    }
}
