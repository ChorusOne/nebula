...
impl serde::Serialize for ResponseBroadcastTx {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.rpc.grpc.v1beta2.ResponseBroadcastTx", len)?;
...
impl<'de> serde::Deserialize<'de> for ResponseBroadcastTx {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.rpc.grpc.v1beta2.ResponseBroadcastTx")
            }
        ...
        deserializer.deserialize_struct("cometbft.rpc.grpc.v1beta2.ResponseBroadcastTx", FIELDS, GeneratedVisitor)
    }
}
