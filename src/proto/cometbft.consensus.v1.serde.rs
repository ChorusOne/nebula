...
impl serde::Serialize for BlockPart {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.consensus.v1.BlockPart", len)?;
        if self.height != 0 {
...
impl<'de> serde::Deserialize<'de> for BlockPart {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.consensus.v1.BlockPart")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<BlockPart, V::Error>
                where
        ...
        deserializer.deserialize_struct("cometbft.consensus.v1.BlockPart", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for EndHeight {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.consensus.v1.EndHeight", len)?;
        if self.height != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("height", ToString::to_string(&self.height).as_str())?;
...
impl<'de> serde::Deserialize<'de> for EndHeight {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.consensus.v1.EndHeight")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<EndHeight, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut height__ = None;
        ...
        deserializer.deserialize_struct("cometbft.consensus.v1.EndHeight", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for HasProposalBlockPart {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.consensus.v1.HasProposalBlockPart", len)?;
        if self.height != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("height", ToString::to_string(&self.height).as_str())?;
...
impl<'de> serde::Deserialize<'de> for HasProposalBlockPart {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        struct GeneratedVisitor;
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = HasProposalBlockPart;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.consensus.v1.HasProposalBlockPart")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<HasProposalBlockPart, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut height__ = None;
        ...
        deserializer.deserialize_struct("cometbft.consensus.v1.HasProposalBlockPart", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for HasVote {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.consensus.v1.HasVote", len)?;
        if self.height != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("height", ToString::to_string(&self.height).as_str())?;
        ...
        if self.r#type != 0 {
            let v = super::super::types::v1::SignedMsgType::try_from(self.r#type)
...
impl<'de> serde::Deserialize<'de> for HasVote {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.consensus.v1.HasVote")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<HasVote, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut height__ = None;
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        ...
                        GeneratedField::Type => {
                            ...
                            r#type__ = Some(map_.next_value::<super::super::types::v1::SignedMsgType>()? as i32);
                        }
                        GeneratedField::Index => {
                            if index__.is_some() {
                                return Err(serde::de::Error::duplicate_field("index"));
        ...
        deserializer.deserialize_struct("cometbft.consensus.v1.HasVote", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Message {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.consensus.v1.Message", len)?;
        if let Some(v) = self.sum.as_ref() {
            match v {
                ...
                message::Sum::HasProposalBlockPart(v) => {
                    struct_ser.serialize_field("hasProposalBlockPart", v)?;
                }
            }
        }
        struct_ser.end()
...
impl<'de> serde::Deserialize<'de> for Message {
        ...
        D: serde::Deserializer<'de>,
    {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "hasProposalBlockPart" | "has_proposal_block_part" => Ok(GeneratedField::HasProposalBlockPart),
                            _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
                        }
                    }
                }
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.consensus.v1.Message")
            }
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::NewRoundStep => {
                            ...
                            sum__ = map_.next_value::<::std::option::Option<_>>()?.map(message::Sum::NewRoundStep)
;
                        }
                        GeneratedField::NewValidBlock => {
                            ...
                            sum__ = map_.next_value::<::std::option::Option<_>>()?.map(message::Sum::NewValidBlock)
;
                        }
                        GeneratedField::Proposal => {
                            ...
                            sum__ = map_.next_value::<::std::option::Option<_>>()?.map(message::Sum::Proposal)
;
                        }
                        GeneratedField::ProposalPol => {
                            ...
                            sum__ = map_.next_value::<::std::option::Option<_>>()?.map(message::Sum::ProposalPol)
;
                        }
                        GeneratedField::BlockPart => {
                            ...
                            sum__ = map_.next_value::<::std::option::Option<_>>()?.map(message::Sum::BlockPart)
;
                        }
                        GeneratedField::Vote => {
                            if sum__.is_some() {
                            ...
                            sum__ = map_.next_value::<::std::option::Option<_>>()?.map(message::Sum::Vote)
;
                        }
                        GeneratedField::HasVote => {
                            ...
                            sum__ = map_.next_value::<::std::option::Option<_>>()?.map(message::Sum::HasVote)
;
                        }
                        GeneratedField::VoteSetMaj23 => {
                            ...
                            sum__ = map_.next_value::<::std::option::Option<_>>()?.map(message::Sum::VoteSetMaj23)
;
                        }
                        GeneratedField::VoteSetBits => {
                            ...
                            sum__ = map_.next_value::<::std::option::Option<_>>()?.map(message::Sum::VoteSetBits)
;
                        }
                        GeneratedField::HasProposalBlockPart => {
                            if sum__.is_some() {
                                return Err(serde::de::Error::duplicate_field("hasProposalBlockPart"));
                            }
                            sum__ = map_.next_value::<::std::option::Option<_>>()?.map(message::Sum::HasProposalBlockPart)
;
                        }
                    }
                }
        ...
        deserializer.deserialize_struct("cometbft.consensus.v1.Message", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MsgInfo {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.consensus.v1.MsgInfo", len)?;
        ...
        if let Some(v) = self.receive_time.as_ref() {
            struct_ser.serialize_field("receiveTime", v)?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for MsgInfo {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.consensus.v1.MsgInfo")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<MsgInfo, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut msg__ = None;
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        ...
                        GeneratedField::ReceiveTime => {
                            ...
                            receive_time__ = map_.next_value()?;
                        }
                    }
                }
                Ok(MsgInfo {
                    ...
                    receive_time: receive_time__,
                })
            }
        }
        deserializer.deserialize_struct("cometbft.consensus.v1.MsgInfo", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for NewRoundStep {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.consensus.v1.NewRoundStep", len)?;
        if self.height != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("height", ToString::to_string(&self.height).as_str())?;
...
impl<'de> serde::Deserialize<'de> for NewRoundStep {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.consensus.v1.NewRoundStep")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<NewRoundStep, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut height__ = None;
        ...
        deserializer.deserialize_struct("cometbft.consensus.v1.NewRoundStep", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for NewValidBlock {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.consensus.v1.NewValidBlock", len)?;
        if self.height != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("height", ToString::to_string(&self.height).as_str())?;
...
impl<'de> serde::Deserialize<'de> for NewValidBlock {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.consensus.v1.NewValidBlock")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<NewValidBlock, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut height__ = None;
        ...
        deserializer.deserialize_struct("cometbft.consensus.v1.NewValidBlock", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Proposal {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.consensus.v1.Proposal", len)?;
...
impl<'de> serde::Deserialize<'de> for Proposal {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.consensus.v1.Proposal")
            }
        ...
        deserializer.deserialize_struct("cometbft.consensus.v1.Proposal", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ProposalPol {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.consensus.v1.ProposalPOL", len)?;
        if self.height != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("height", ToString::to_string(&self.height).as_str())?;
...
impl<'de> serde::Deserialize<'de> for ProposalPol {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.consensus.v1.ProposalPOL")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<ProposalPol, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut height__ = None;
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        ...
                        GeneratedField::ProposalPol => {
                            ...
                            proposal_pol__ = map_.next_value()?;
                        }
                    }
                }
                Ok(ProposalPol {
        ...
        deserializer.deserialize_struct("cometbft.consensus.v1.ProposalPOL", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for TimedWalMessage {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.consensus.v1.TimedWALMessage", len)?;
...
impl<'de> serde::Deserialize<'de> for TimedWalMessage {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.consensus.v1.TimedWALMessage")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<TimedWalMessage, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut time__ = None;
        ...
        deserializer.deserialize_struct("cometbft.consensus.v1.TimedWALMessage", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for TimeoutInfo {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.consensus.v1.TimeoutInfo", len)?;
...
impl<'de> serde::Deserialize<'de> for TimeoutInfo {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.consensus.v1.TimeoutInfo")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<TimeoutInfo, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
        ...
        deserializer.deserialize_struct("cometbft.consensus.v1.TimeoutInfo", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Vote {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.consensus.v1.Vote", len)?;
...
impl<'de> serde::Deserialize<'de> for Vote {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.consensus.v1.Vote")
            }
        ...
        deserializer.deserialize_struct("cometbft.consensus.v1.Vote", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for VoteSetBits {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.consensus.v1.VoteSetBits", len)?;
        if self.height != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("height", ToString::to_string(&self.height).as_str())?;
...
impl<'de> serde::Deserialize<'de> for VoteSetBits {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.consensus.v1.VoteSetBits")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<VoteSetBits, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut height__ = None;
        ...
        deserializer.deserialize_struct("cometbft.consensus.v1.VoteSetBits", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for VoteSetMaj23 {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.consensus.v1.VoteSetMaj23", len)?;
        if self.height != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("height", ToString::to_string(&self.height).as_str())?;
...
impl<'de> serde::Deserialize<'de> for VoteSetMaj23 {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.consensus.v1.VoteSetMaj23")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<VoteSetMaj23, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut height__ = None;
        ...
        deserializer.deserialize_struct("cometbft.consensus.v1.VoteSetMaj23", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for WalMessage {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.consensus.v1.WALMessage", len)?;
        if let Some(v) = self.sum.as_ref() {
            match v {
...
impl<'de> serde::Deserialize<'de> for WalMessage {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.consensus.v1.WALMessage")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<WalMessage, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut sum__ = None;
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::EventDataRoundState => {
                            ...
                            sum__ = map_.next_value::<::std::option::Option<_>>()?.map(wal_message::Sum::EventDataRoundState)
;
                        }
                        GeneratedField::MsgInfo => {
                            ...
                            sum__ = map_.next_value::<::std::option::Option<_>>()?.map(wal_message::Sum::MsgInfo)
;
                        }
                        GeneratedField::TimeoutInfo => {
                            ...
                            sum__ = map_.next_value::<::std::option::Option<_>>()?.map(wal_message::Sum::TimeoutInfo)
;
                        }
                        GeneratedField::EndHeight => {
                            ...
                            sum__ = map_.next_value::<::std::option::Option<_>>()?.map(wal_message::Sum::EndHeight)
;
                        }
                    }
                }
        ...
        deserializer.deserialize_struct("cometbft.consensus.v1.WALMessage", FIELDS, GeneratedVisitor)
    }
}
