...
impl serde::Serialize for AbciResponsesInfo {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.state.v1beta3.ABCIResponsesInfo", len)?;
...
impl<'de> serde::Deserialize<'de> for AbciResponsesInfo {
        ...
        D: serde::Deserializer<'de>,
    {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "responseFinalizeBlock" | "response_finalize_block" => Ok(GeneratedField::ResponseFinalizeBlock),
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.state.v1beta3.ABCIResponsesInfo")
            }
                    ...
                    match k {
                        ...
                        GeneratedField::ResponseFinalizeBlock => {
                            if response_finalize_block__.is_some() {
                                return Err(serde::de::Error::duplicate_field("responseFinalizeBlock"));
                            }
        ...
        deserializer.deserialize_struct("cometbft.state.v1beta3.ABCIResponsesInfo", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ConsensusParamsInfo {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.state.v1beta3.ConsensusParamsInfo", len)?;
...
impl<'de> serde::Deserialize<'de> for ConsensusParamsInfo {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.state.v1beta3.ConsensusParamsInfo")
            }
        ...
        deserializer.deserialize_struct("cometbft.state.v1beta3.ConsensusParamsInfo", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for LegacyAbciResponses {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.state.v1beta3.LegacyABCIResponses", len)?;
        if !self.deliver_txs.is_empty() {
...
impl<'de> serde::Deserialize<'de> for LegacyAbciResponses {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.state.v1beta3.LegacyABCIResponses")
            }
        ...
        deserializer.deserialize_struct("cometbft.state.v1beta3.LegacyABCIResponses", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ResponseBeginBlock {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.state.v1beta3.ResponseBeginBlock", len)?;
        if !self.events.is_empty() {
...
impl<'de> serde::Deserialize<'de> for ResponseBeginBlock {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.state.v1beta3.ResponseBeginBlock")
            }
        ...
        deserializer.deserialize_struct("cometbft.state.v1beta3.ResponseBeginBlock", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ResponseEndBlock {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.state.v1beta3.ResponseEndBlock", len)?;
        if !self.validator_updates.is_empty() {
...
impl<'de> serde::Deserialize<'de> for ResponseEndBlock {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.state.v1beta3.ResponseEndBlock")
            }
        ...
        deserializer.deserialize_struct("cometbft.state.v1beta3.ResponseEndBlock", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for State {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.state.v1beta3.State", len)?;
...
impl<'de> serde::Deserialize<'de> for State {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.state.v1beta3.State")
            }
        ...
        deserializer.deserialize_struct("cometbft.state.v1beta3.State", FIELDS, GeneratedVisitor)
    }
}
