...
impl serde::Serialize for BitArray {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.libs.bits.v1.BitArray", len)?;
        if self.bits != 0 {
...
impl<'de> serde::Deserialize<'de> for BitArray {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.libs.bits.v1.BitArray")
            }
        ...
        deserializer.deserialize_struct("cometbft.libs.bits.v1.BitArray", FIELDS, GeneratedVisitor)
    }
}
