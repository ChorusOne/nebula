...
impl serde::Serialize for BlockRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.blocksync.v1beta1.BlockRequest", len)?;
        if self.height != 0 {
...
impl<'de> serde::Deserialize<'de> for BlockRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.blocksync.v1beta1.BlockRequest")
            }
        ...
        deserializer.deserialize_struct("cometbft.blocksync.v1beta1.BlockRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for BlockResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.blocksync.v1beta1.BlockResponse", len)?;
...
impl<'de> serde::Deserialize<'de> for BlockResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.blocksync.v1beta1.BlockResponse")
            }
        ...
        deserializer.deserialize_struct("cometbft.blocksync.v1beta1.BlockResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Message {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.blocksync.v1beta1.Message", len)?;
...
impl<'de> serde::Deserialize<'de> for Message {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.blocksync.v1beta1.Message")
            }
...
;
        ...
        deserializer.deserialize_struct("cometbft.blocksync.v1beta1.Message", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for NoBlockResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.blocksync.v1beta1.NoBlockResponse", len)?;
        if self.height != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("height", ToString::to_string(&self.height).as_str())?;
...
impl<'de> serde::Deserialize<'de> for NoBlockResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.blocksync.v1beta1.NoBlockResponse")
            }
        ...
        deserializer.deserialize_struct("cometbft.blocksync.v1beta1.NoBlockResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for StatusRequest {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("cometbft.blocksync.v1beta1.StatusRequest", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for StatusRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.blocksync.v1beta1.StatusRequest")
            }
        ...
        deserializer.deserialize_struct("cometbft.blocksync.v1beta1.StatusRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for StatusResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.blocksync.v1beta1.StatusResponse", len)?;
        if self.height != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("height", ToString::to_string(&self.height).as_str())?;
...
impl<'de> serde::Deserialize<'de> for StatusResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.blocksync.v1beta1.StatusResponse")
            }
        ...
        deserializer.deserialize_struct("cometbft.blocksync.v1beta1.StatusResponse", FIELDS, GeneratedVisitor)
    }
}
