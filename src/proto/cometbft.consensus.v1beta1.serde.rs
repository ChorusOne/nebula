...
impl serde::Serialize for BlockPart {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.consensus.v1beta1.BlockPart", len)?;
        if self.height != 0 {
...
impl<'de> serde::Deserialize<'de> for BlockPart {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.consensus.v1beta1.BlockPart")
            }
        ...
        deserializer.deserialize_struct("cometbft.consensus.v1beta1.BlockPart", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for EndHeight {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.consensus.v1beta1.EndHeight", len)?;
        if self.height != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("height", ToString::to_string(&self.height).as_str())?;
...
impl<'de> serde::Deserialize<'de> for EndHeight {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.consensus.v1beta1.EndHeight")
            }
        ...
        deserializer.deserialize_struct("cometbft.consensus.v1beta1.EndHeight", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for HasVote {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.consensus.v1beta1.HasVote", len)?;
        if self.height != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("height", ToString::to_string(&self.height).as_str())?;
        ...
        if self.r#type != 0 {
            let v = super::super::types::v1beta1::SignedMsgType::try_from(self.r#type)
...
impl<'de> serde::Deserialize<'de> for HasVote {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.consensus.v1beta1.HasVote")
            }
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        ...
                        GeneratedField::Type => {
                            ...
                            r#type__ = Some(map_.next_value::<super::super::types::v1beta1::SignedMsgType>()? as i32);
                        }
        ...
        deserializer.deserialize_struct("cometbft.consensus.v1beta1.HasVote", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Message {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.consensus.v1beta1.Message", len)?;
...
impl<'de> serde::Deserialize<'de> for Message {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.consensus.v1beta1.Message")
            }
...
;
        ...
        deserializer.deserialize_struct("cometbft.consensus.v1beta1.Message", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for MsgInfo {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.consensus.v1beta1.MsgInfo", len)?;
...
impl<'de> serde::Deserialize<'de> for MsgInfo {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.consensus.v1beta1.MsgInfo")
            }
        ...
        deserializer.deserialize_struct("cometbft.consensus.v1beta1.MsgInfo", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for NewRoundStep {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.consensus.v1beta1.NewRoundStep", len)?;
        if self.height != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("height", ToString::to_string(&self.height).as_str())?;
...
impl<'de> serde::Deserialize<'de> for NewRoundStep {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.consensus.v1beta1.NewRoundStep")
            }
        ...
        deserializer.deserialize_struct("cometbft.consensus.v1beta1.NewRoundStep", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for NewValidBlock {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.consensus.v1beta1.NewValidBlock", len)?;
        if self.height != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("height", ToString::to_string(&self.height).as_str())?;
...
impl<'de> serde::Deserialize<'de> for NewValidBlock {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.consensus.v1beta1.NewValidBlock")
            }
        ...
        deserializer.deserialize_struct("cometbft.consensus.v1beta1.NewValidBlock", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Proposal {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.consensus.v1beta1.Proposal", len)?;
...
impl<'de> serde::Deserialize<'de> for Proposal {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.consensus.v1beta1.Proposal")
            }
        ...
        deserializer.deserialize_struct("cometbft.consensus.v1beta1.Proposal", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ProposalPol {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.consensus.v1beta1.ProposalPOL", len)?;
        if self.height != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("height", ToString::to_string(&self.height).as_str())?;
...
impl<'de> serde::Deserialize<'de> for ProposalPol {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.consensus.v1beta1.ProposalPOL")
            }
        ...
        deserializer.deserialize_struct("cometbft.consensus.v1beta1.ProposalPOL", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for TimedWalMessage {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.consensus.v1beta1.TimedWALMessage", len)?;
...
impl<'de> serde::Deserialize<'de> for TimedWalMessage {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.consensus.v1beta1.TimedWALMessage")
            }
        ...
        deserializer.deserialize_struct("cometbft.consensus.v1beta1.TimedWALMessage", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for TimeoutInfo {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.consensus.v1beta1.TimeoutInfo", len)?;
...
impl<'de> serde::Deserialize<'de> for TimeoutInfo {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.consensus.v1beta1.TimeoutInfo")
            }
        ...
        deserializer.deserialize_struct("cometbft.consensus.v1beta1.TimeoutInfo", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Vote {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.consensus.v1beta1.Vote", len)?;
...
impl<'de> serde::Deserialize<'de> for Vote {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.consensus.v1beta1.Vote")
            }
        ...
        deserializer.deserialize_struct("cometbft.consensus.v1beta1.Vote", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for VoteSetBits {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.consensus.v1beta1.VoteSetBits", len)?;
        if self.height != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("height", ToString::to_string(&self.height).as_str())?;
...
impl<'de> serde::Deserialize<'de> for VoteSetBits {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.consensus.v1beta1.VoteSetBits")
            }
        ...
        deserializer.deserialize_struct("cometbft.consensus.v1beta1.VoteSetBits", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for VoteSetMaj23 {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.consensus.v1beta1.VoteSetMaj23", len)?;
        if self.height != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("height", ToString::to_string(&self.height).as_str())?;
...
impl<'de> serde::Deserialize<'de> for VoteSetMaj23 {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.consensus.v1beta1.VoteSetMaj23")
            }
        ...
        deserializer.deserialize_struct("cometbft.consensus.v1beta1.VoteSetMaj23", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for WalMessage {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.consensus.v1beta1.WALMessage", len)?;
        if let Some(v) = self.sum.as_ref() {
            match v {
...
impl<'de> serde::Deserialize<'de> for WalMessage {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.consensus.v1beta1.WALMessage")
            }
...
;
        ...
        deserializer.deserialize_struct("cometbft.consensus.v1beta1.WALMessage", FIELDS, GeneratedVisitor)
    }
}
