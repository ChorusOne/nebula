...
impl serde::Serialize for AbciResponses {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.state.v1beta2.ABCIResponses", len)?;
        if !self.deliver_txs.is_empty() {
...
impl<'de> serde::Deserialize<'de> for AbciResponses {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.state.v1beta2.ABCIResponses")
            }
        ...
        deserializer.deserialize_struct("cometbft.state.v1beta2.ABCIResponses", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for AbciResponsesInfo {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.state.v1beta2.ABCIResponsesInfo", len)?;
...
impl<'de> serde::Deserialize<'de> for AbciResponsesInfo {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.state.v1beta2.ABCIResponsesInfo")
            }
        ...
        deserializer.deserialize_struct("cometbft.state.v1beta2.ABCIResponsesInfo", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ConsensusParamsInfo {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.state.v1beta2.ConsensusParamsInfo", len)?;
...
impl<'de> serde::Deserialize<'de> for ConsensusParamsInfo {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.state.v1beta2.ConsensusParamsInfo")
            }
        ...
        deserializer.deserialize_struct("cometbft.state.v1beta2.ConsensusParamsInfo", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for State {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.state.v1beta2.State", len)?;
...
impl<'de> serde::Deserialize<'de> for State {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.state.v1beta2.State")
            }
        ...
        deserializer.deserialize_struct("cometbft.state.v1beta2.State", FIELDS, GeneratedVisitor)
    }
}
