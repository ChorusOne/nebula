...
impl serde::Serialize for AuthSigMessage {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.p2p.v1.AuthSigMessage", len)?;
...
impl<'de> serde::Deserialize<'de> for AuthSigMessage {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.p2p.v1.AuthSigMessage")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<AuthSigMessage, V::Error>
                where
        ...
        deserializer.deserialize_struct("cometbft.p2p.v1.AuthSigMessage", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for DefaultNodeInfo {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.p2p.v1.DefaultNodeInfo", len)?;
...
impl<'de> serde::Deserialize<'de> for DefaultNodeInfo {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.p2p.v1.DefaultNodeInfo")
            }
        ...
        deserializer.deserialize_struct("cometbft.p2p.v1.DefaultNodeInfo", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for DefaultNodeInfoOther {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.p2p.v1.DefaultNodeInfoOther", len)?;
        if !self.tx_index.is_empty() {
...
impl<'de> serde::Deserialize<'de> for DefaultNodeInfoOther {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.p2p.v1.DefaultNodeInfoOther")
            }
        ...
        deserializer.deserialize_struct("cometbft.p2p.v1.DefaultNodeInfoOther", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Message {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.p2p.v1.Message", len)?;
...
impl<'de> serde::Deserialize<'de> for Message {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.p2p.v1.Message")
            }
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::PexRequest => {
                            ...
                            sum__ = map_.next_value::<::std::option::Option<_>>()?.map(message::Sum::PexRequest)
;
                        }
                        GeneratedField::PexAddrs => {
                            ...
                            sum__ = map_.next_value::<::std::option::Option<_>>()?.map(message::Sum::PexAddrs)
;
                        }
                    }
                }
        ...
        deserializer.deserialize_struct("cometbft.p2p.v1.Message", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for NetAddress {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.p2p.v1.NetAddress", len)?;
        if !self.id.is_empty() {
...
impl<'de> serde::Deserialize<'de> for NetAddress {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.p2p.v1.NetAddress")
            }
        ...
        deserializer.deserialize_struct("cometbft.p2p.v1.NetAddress", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Packet {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.p2p.v1.Packet", len)?;
        if let Some(v) = self.sum.as_ref() {
            match v {
...
impl<'de> serde::Deserialize<'de> for Packet {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.p2p.v1.Packet")
            }
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::PacketPing => {
                            ...
                            sum__ = map_.next_value::<::std::option::Option<_>>()?.map(packet::Sum::PacketPing)
;
                        }
                        GeneratedField::PacketPong => {
                            ...
                            sum__ = map_.next_value::<::std::option::Option<_>>()?.map(packet::Sum::PacketPong)
;
                        }
                        GeneratedField::PacketMsg => {
                            ...
                            sum__ = map_.next_value::<::std::option::Option<_>>()?.map(packet::Sum::PacketMsg)
;
                        }
                    }
                }
        ...
        deserializer.deserialize_struct("cometbft.p2p.v1.Packet", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for PacketMsg {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.p2p.v1.PacketMsg", len)?;
        if self.channel_id != 0 {
...
impl<'de> serde::Deserialize<'de> for PacketMsg {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.p2p.v1.PacketMsg")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<PacketMsg, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
        ...
        deserializer.deserialize_struct("cometbft.p2p.v1.PacketMsg", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for PacketPing {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("cometbft.p2p.v1.PacketPing", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for PacketPing {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.p2p.v1.PacketPing")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<PacketPing, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
        ...
        deserializer.deserialize_struct("cometbft.p2p.v1.PacketPing", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for PacketPong {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("cometbft.p2p.v1.PacketPong", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for PacketPong {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.p2p.v1.PacketPong")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<PacketPong, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                while map_.next_key::<GeneratedField>()?.is_some() {
        ...
        deserializer.deserialize_struct("cometbft.p2p.v1.PacketPong", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for PexAddrs {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.p2p.v1.PexAddrs", len)?;
        if !self.addrs.is_empty() {
...
impl<'de> serde::Deserialize<'de> for PexAddrs {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.p2p.v1.PexAddrs")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<PexAddrs, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
        ...
        deserializer.deserialize_struct("cometbft.p2p.v1.PexAddrs", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for PexRequest {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let len = 0;
        let struct_ser = serializer.serialize_struct("cometbft.p2p.v1.PexRequest", len)?;
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for PexRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.p2p.v1.PexRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<PexRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                while map_.next_key::<GeneratedField>()?.is_some() {
        ...
        deserializer.deserialize_struct("cometbft.p2p.v1.PexRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ProtocolVersion {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cometbft.p2p.v1.ProtocolVersion", len)?;
        if self.p2p != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
...
impl<'de> serde::Deserialize<'de> for ProtocolVersion {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct cometbft.p2p.v1.ProtocolVersion")
            }
        ...
        deserializer.deserialize_struct("cometbft.p2p.v1.ProtocolVersion", FIELDS, GeneratedVisitor)
    }
}
